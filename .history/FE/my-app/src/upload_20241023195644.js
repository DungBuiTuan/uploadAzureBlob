...
const Upload = () => {
  ...
  const handleUpload = async () => {
    try {
      ...
      console.log("DDang goij azure");
      console.log("file: ", file.name);
      // const blockBlobClient = containerClient.getBlockBlobClient(file.name);
      // console.log("file.buffer: ", file.type);
      // await blockBlobClient.uploadData(file.buffer);

      var processImageBuffer = new ArrayBuffer(file);  // convert image to buffer array

var blob = new Blob(file);                       // convert buffer array to promise array

var processImageBuffer = blob.arrayBuffer();

var processImageBuffer = arrayBufferToBuffer(processImageBuffer);

      // const imageUrl = blockBlobClient.url;
      console.log("hihi:", processImageBuffer);
